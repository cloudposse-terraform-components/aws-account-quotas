...
- [AWS CLI list services](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/service-quotas/list-services.html) - Command to list service codes: aws service-quotas list-services

- [AWS CLI list service quotas](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/service-quotas/list-service-quotas.html) - Command to list service quotas: aws service-quotas list-service-quotas. Note: 'For some quotas, only the default values are available.'

- [Medium article](https://medium.com/@jsonk/the-limit-does-not-exist-hidden-visibility-of-aws-service-limits-4b786f846bc0) - Explains how many AWS service limits are not available.




[<img src="https://cloudposse.com/logo-300x69.svg" height="32" align="right"/>](https://cpco.io/homepage?utm_source=github&utm_medium=readme&utm_campaign=cloudposse-terraform-components/aws-account-quotas&utm_content=)
